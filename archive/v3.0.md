...
```json
{
  ...
  "exec_ms": <number>,
  "cost_paid": <number>,
  "used_with": ["<tool_id>", "<tool_id>"],
  "execution_order": ["<tool_id>", "<tool_id>"],
  "currency": "<string>",
...
- used_with (array): List of other tool IDs used in this execution flow
- execution_order (array): Ordered sequence of tools used (implies used_with)
